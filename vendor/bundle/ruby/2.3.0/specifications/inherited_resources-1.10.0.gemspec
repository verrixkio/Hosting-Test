...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<actionpack>.freeze, ["< 6.0", ">= 5.0"])
      s.add_runtime_dependency(%q<railties>.freeze, ["< 6.0", ">= 5.0"])
      s.add_runtime_dependency(%q<has_scope>.freeze, ["~> 0.6"])
    else
      s.add_dependency(%q<responders>.freeze, ["~> 2.0"])
      s.add_dependency(%q<actionpack>.freeze, ["< 6.0", ">= 5.0"])
      s.add_dependency(%q<railties>.freeze, ["< 6.0", ">= 5.0"])
